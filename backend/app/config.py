...
# =============================================================================
# GOOGLE DRIVE / OAUTH — DEPRECATED, UNUSED (v2 rebuild removed Drive sync
# entirely; drive_service.py, multi_drive_service.py, and the Drive UI tab
# are deleted). These constants are read by nothing. Kept only so an old
# .env with these keys doesn't error on load. Safe to delete in a follow-up
# cleanup pass once no deployment still has these env vars set.
# =============================================================================
