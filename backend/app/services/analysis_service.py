...
Improvements over v1:
  ...
  - Google Drive sync removed entirely (v2 rebuild) — ingestion is upload-driven
    (local disk / Cloudflare R2 via StorageService) or via the generic
    ingestion_service job queue, not tied to any one external source
